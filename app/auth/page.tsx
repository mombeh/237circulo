                ...
                <div className="bg-[var(--card)] border border-[var(--border)] p-8 rounded-2xl shadow-xl">
                    {!isSent ? (
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <h1 className="font-syne text-2xl font-bold mb-2">Welcome back</h1>
                            ...
                            <form onSubmit={handleLogin} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-[var(--background)] border border-[var(--border)] rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-primary/20 focus:border-green-primary transition-all"
                                    />
                                </div>
                        ...
                        <div className="text-center py-4 animate-in zoom-in duration-300">
                            ...
                            <h2 className="font-syne text-2xl font-bold mb-2">Check your inbox</h2>
                            <p className="text-[var(--text-dim)] text-sm mb-8">
